...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Main = function (model, element, canvasElement, opts) {
            ...
            // bottom buttons
            this.twoDCamera = function () {
                scope.controls.enabled = false
                camera.position.set(450, 1100000, 9000);
                scope.controls.update();
            
            };

            this.middleCamera = function () {
                arr = [
                    [964.6, 597.523, 557.904], 
                    [1016, 528.482, -520.57]
                ]
                scope.controls.enabled = false
                camera.position.set(964.6, 645.870, 557.904);
                /* camera.position.set(964.6, 597.523, 557.904); */
                scope.controls.update();
            };

            this.threeDCamera = function () {
